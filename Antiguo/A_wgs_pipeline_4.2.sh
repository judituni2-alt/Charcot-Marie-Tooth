...
# Uso:
#   ./B_wgs_pipeline.sh
#       -1 CMT1234_R1.fastq.gz -2 CMT1234_R2.fastq.gz -s CMT1234 -r ref.fasta - directorio_resultados
#
#
#
...
#   de continuar. El orden de los lanes no es un factor a tener en cuenta pero
#   si se debe mantener el mismo orden entre R1 y R2
#
#   ./B_wgs_pipeline.sh
...
# Para archivos que se conoce que son de alta calidad de lectura está activado
# por defecto la opción de realizar un subsample representativo 2000000 reads de FASTQ para
# evitar leerlo entero. Si se quiere analizar todo el FASTQ hay que indicarlo con -q 0 
###############################################################################
...
# https://linuxize.com/post/bash-best-practices/  --> Investigar mas buenas practicas
...
# --- Otros parámetros de fastp que se pueden añadir ---
# Link a página web
...
Uso: $0  -r ref.fasta -1 R1.fastq.gz -2 R2.fastq.gz -s sample_id [-t threads] [-o outdir] [-b] [-q subsample_reads]
  ...
  -r        Genoma de referencia en formato FASTA
